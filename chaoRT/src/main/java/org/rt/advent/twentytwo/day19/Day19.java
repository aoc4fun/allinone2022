...
public class Day19 extends DayPuzzle {
    ...
    public String puzzle1() throws PuzzleFailedException {
        try {
            ...
            throw new PuzzleFailedException("no result for puzzle "+ Day19.class.getSimpleName(),e);
        }
